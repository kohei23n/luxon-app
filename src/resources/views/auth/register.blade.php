    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="mus_email_address" class="block mt-1 w-full" type="email" name="mus_email_address"
                :value="old('mus_email_address')" required autocomplete="username" />
        ...
        <div>
            ...
            <x-text-input id="mus_user_password" class="block mt-1 w-full" type="password" name="mus_user_password"
        ...
        <div>
            ...
            <x-text-input id="mus_user_password_confirmation" class="block mt-1 w-full" type="password"
