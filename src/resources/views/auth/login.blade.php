...
<body>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input style="margin-top: 10px; background-color: white;" id="mus_email_address" class="block mt-1 w-full" type="email" name="mus_email_address" :value="old('mus_email_address')" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input style="margin-top: 10px; background-color: white;" id="mus_user_password" class="block mt-1 w-full"
                            type="password"
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button style="color: blue;;" class="ml-3">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
