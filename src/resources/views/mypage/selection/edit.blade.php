    ...
    <form method="post" action="{{ route('mypage.selectionUpdate', $status->tss_selection_status_id) }}">
        ...
        <div>
            ...
            <div>
                ...
                <x-text-input id="tss_company_name" :value="$status->tss_company_name" type="text" name="tss_company_name" />
            ...
            <div>
                ...
                <x-text-input id="tss_preference_ranking" :value="$status->tss_preference_ranking" type="number"
            ...
            <div>
                ...
                <x-text-input id="tss_selection_date" :value="$formattedDate" type="date" name="tss_selection_date" />
