...
class UserDetailTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        UserDetail::create([
            'tud_user_id' => 2,
            'tud_current_university' => 'なし',
            'tud_first_industry_preference' => 'なし',
        ...
        UserDetail::create([
            ...
            'tud_first_industry_preference' => '戦コン',
            'tud_second_industry_preference' => 'IT',
            'tud_event_attendance_remaining' => 0,           'tud_interview_count_remaining' => 1,
            'tud_case_study_count_remaining' => 0,
            'tud_es_count_remaining' => 1,
        ]);
