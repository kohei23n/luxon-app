...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('luxon_trx_selection_status', function (Blueprint $table) {
            ...
            $table->dateTime('tss_selection_date')->nullable()->comment('選考日時');
            $table->char('tss_delete_flag', 1)->default('0')->comment('削除フラグ');
            ...
            $table->foreign('tss_user_id', 'fk:luxon_tss_user_id')->references('mus_user_id')->on('luxon_mst_user');
        });
    }
