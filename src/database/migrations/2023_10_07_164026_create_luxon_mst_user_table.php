...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('luxon_mst_user', function (Blueprint $table) {
            ...
            $table->string('mus_current_university', 50)->comment('所属大学');
            $table->string('mus_service_plan', 50)->comment('サービスプラン');
            $table->string('mus_first_industry_preference', 50)->comment('第一志望業界');
            $table->string('mus_second_industry_preference', 50)->comment('第二志望業界');
